# -*- coding: utf-8 -*-
"""treesatai-chm-baseline

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Lccsx0si8CJAI8Oi5y9d91RkJ8DBUQZH
"""
...
"""### Multi-task training & evaluation for MultiTaskUNet"""
...
criterion = None
def inference(model, best_state, task="reg", train_loader=train_loader, val_loader=val_loader, test_loader=test_loader, criterion=criterion, device=device):
...
for epoch in range(1, num_epochs + 1):
    ...
    print(
        ...
        "\tweighted F1: {f1_weighted:.4f}, weighted mAP: {map_weighted:.4f}, "
        "accuracy: {accuracy:.4f}, val_loss: {val_loss:.4f}".format(**val_metrics)
    )
    ...
    history["val_val_loss"].append(float(val_metrics["val_loss"]))
...
# val_true, val_pred = collect_regression_pairs(model, val_loader)
# plot_regression_joint_with_hists(val_true, val_pred, max_value=40)

# train_true, train_pred = collect_regression_pairs(model, train_loader)
# plot_regression_joint_with_hists(train_true, train_pred, max_value=60)
