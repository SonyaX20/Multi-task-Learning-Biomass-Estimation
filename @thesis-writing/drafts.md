...
- forest monitoring
- optical vs. SAR: optical remote sensing (cloud cover, temporal gaps); SAR, all-weather, day-night capability
- deep learning for remote sensing tasks
### 1.2 Research Objectives and Questions
- primary: MTL framework for both classification and regression tasks in forest monitoring
	1. extending TreeSatAI dataset
	2. can MTL improve performance over single-task models for forest parameter extraction? or how do different MTL architectures affect task interactions (positive/negative transfer)?
