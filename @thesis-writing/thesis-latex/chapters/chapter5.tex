...
The datasets used in this thesis are publicly available. The TreeSatAI benchmark dataset~\citep{ahlswede_treesatai_2023} is available at \url{https://zenodo.org/records/6598391}. The German LiDAR elevation data (DTM/DSM) were obtained from the Lower Saxony open geodata portal at \url{https://ni-lgln-opengeodata.hub.arcgis.com}. The iMAESTRO synthetic forest dataset~\citep{aussenac_diameter_2023} is available at \url{https://zenodo.org/records/10204837}. The original TreeSatAI benchmark code is maintained at \url{https://git.tu-berlin.de/rsim/pixel-based-classification-treesatai}.

All code developed for this thesis is publicly available on GitHub. The TreeSatAI-CHM implementation including dataset extension and multi-task learning experiments is available at \url{https://github.com/SonjaX1927/Multi-task-Learning-Biomass-Estimation/tree/treesat}. The iMAESTRO physics-aware multi-task learning framework is available at \url{https://github.com/SonjaX1927/Multi-task-Learning-Biomass-Estimation}. The repositories include data preprocessing pipelines, model implementations and training configurations.
